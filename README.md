<h1 align="center">
  <img alt="Logo" src="../appcaronatruck/src/assets/logo.png" width="200px">
</h1>
...
```bash
$ git clone https://github.com/bruno07dev/appcaronatruck.git && cd appcaronatruck
```
...
$ gh repo fork bruno07dev/appcaronatruck
```
...
```bash
# Clone your fork
$ git clone your-fork-url && cd appcaronatruck
